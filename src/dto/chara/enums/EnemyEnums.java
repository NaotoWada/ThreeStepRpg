...
public class EnemyEnums {
    ...
    @Getter
    public enum ENEMY {
        SLIME("スライム", "slime.png", ENEMY_PARAM.SLIME, RANK.LOW), //
        BAT("バット", "bat.png", ENEMY_PARAM.BAT, RANK.LOW), //
        MOUSE("マウス", "mouse.png", ENEMY_PARAM.MOUSE, RANK.LOW), //
        EGG("ミスティックエッグ", "egg.png", ENEMY_PARAM.EGG, RANK.LOW), //
        GOBLIN("ゴブリン", "goblin.png", ENEMY_PARAM.GOBLIN, RANK.MID), //
        GOBLIN_MASTER("ゴブリンマスター", "goblinMaster.png", ENEMY_PARAM.GOBLIN_MASTER, RANK.MID), //
        TIRANT("ドラゴン", "dragon.png", ENEMY_PARAM.TYRANT, RANK.BOSS); //
