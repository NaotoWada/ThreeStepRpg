...
public class JOBManage {
    ...
    public enum JOB {
        ...
        WARRIOR_M("ウォリアー", "warrior_m.png", "full_warrior_m.png", JOB_PARAM_CORRECTION.WARRIOR_M, JOB_PARAM_STATUS.WARRIOR_M), //
        WARRIOR_F("ウォリアー", "warrior_f.png", "full_warrior_f.png", JOB_PARAM_CORRECTION.WARRIOR_F, JOB_PARAM_STATUS.WARRIOR_F), //
        WITCH_F  ("ウィッチ",   "witch_f.png",   "full_witch_f.png",   JOB_PARAM_CORRECTION.WITCH_F,   JOB_PARAM_STATUS.WITCH_F),   //
        PRIEST_F ("プリースト", "priest_f.png",  "full_priest_f.png",  JOB_PARAM_CORRECTION.PRIEST_F,  JOB_PARAM_STATUS.PRIEST_F),  //
        ARCHER_F ("アーチャー", "archer_f.png",  "full_archer_f.png",  JOB_PARAM_CORRECTION.ARCHER_F,  JOB_PARAM_STATUS.ARCHER_F),  //
        CHIEF_M  ("シーフ",     "chief_m.png",   "full_chief_m.png",   JOB_PARAM_CORRECTION.CHIEF_M,   JOB_PARAM_STATUS.CHIEF_M);   //
