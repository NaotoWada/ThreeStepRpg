...
public class Chief extends Characters {

    private IDamage _Damage;

    public Chief(String _Name, EP_TYPE _Type, JOB _Job, int _Level, int _Id, int _Hp, int _MHp,
    ...
    public ActionEffect action(Characters[] charas) {
        ...
        effect.setEffect(EFFECT.KNIFE);

        return effect;
    }

    @Override
    public Chief deepCopy() {
        System.out.println("Chief.deepCopy() シーフをコピーしました。");
