...
public class TooltipBehavior extends TooltipBehaviorBase<Tooltip> {
    ...
    public static TooltipBehavior createManagedInstance(final Duration open, final Duration hide,
            final Duration left) {
        final TooltipBehavior t = new TooltipBehavior();
        if (open != null) {
    ...
    /**
     * {@link TooltipBehavior#getDefaultTooltip()}で得られる Tooltipを用いてインストールする
     *
     * @param node
     */
