 ...
 * @param <P>
 */
public abstract class TooltipBehaviorBase<P extends PopupWindow> extends SinglePopupBehavior<P> {
    ...
    public final ObjectProperty<Duration> openDurationProperty() {
        if (openDurationProperty == null) {
            openDurationProperty =
                    new SimpleObjectProperty<>(this, "openDuration", DEFAULT_OPEN_DURATION);
        }
    ...
    public final ObjectProperty<Duration> hideDurationProperty() {
        if (hideDurationProperty == null) {
            hideDurationProperty =
                    new SimpleObjectProperty<>(this, "hideDuration", DEFAULT_HIDE_DURATION);
        }
    ...
    /**
     * ポップアップが表示テイルときに、ポップアップが表示の原因となったNodeからマウスが放れた後に、 ウィンドウが表示になっている時間
     *
     * @return
     */
    public final ObjectProperty<Duration> leftDurationProperty() {
        if (leftDurationProperty == null) {
            leftDurationProperty =
                    new SimpleObjectProperty<>(this, "leftDuration", DEFAULT_LEFT_DURATION);
        }
    ...
    protected static final Duration DEFAULT_OPEN_DURATION = new Duration(1000),
            DEFAULT_HIDE_DURATION = new Duration(5000), DEFAULT_LEFT_DURATION = new Duration(200);
